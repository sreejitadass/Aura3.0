      ...
      <section className="relative min-h-[90vh] mt-20 flex flex-col items-center justify-center py-12 px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-plus-jakarta tracking-tight">
            <span className="inline-block bg-gradient-to-r from-[#7fbfb0] via-[#9ad6c8] to-[#6fb3a2] bg-clip-text text-transparent">
              Find Peace
            </span>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-16 space-y-4 text-white ">
            <h2 className="text-3xl font-bold bg-gradient-to-r from-[#7fbfb0] to-[#6fb3a2] bg-clip-text text-transparent">
              How Aura Helps You
            </h2>
